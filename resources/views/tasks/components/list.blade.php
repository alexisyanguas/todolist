...
@section('header')
    ...
    <div
        ...
        {{-- <%= link_to "Voir les voyages", '/trips', class: "flex items-center justify-center bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 :bg-primary-600 :hover:bg-primary-700 focus:outline-none :focus:ring-primary-800" %> --}}
